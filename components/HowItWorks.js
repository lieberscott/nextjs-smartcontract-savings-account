  ...
  return (
    ...
    <div className="w-full max-w-lg mt-8">      
      ...
      <ul className="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-500">
        <li className="flex">
          <svg className="w-4 h-4 mr-1.5 text-green-500 dark:text-green-400 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
        ...
        <li className="flex">
          ...
          The account is for people who want an extra layer of security for users who control their own wallet. Note: This can NOT be used to back up centralized exchange accounts.
          </p>
        </li>
        <li className="flex">
          <svg className="w-4 h-4 mr-1.5 text-green-500 dark:text-green-400 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
          <p><strong className="font-semibold text-gray-900 dark:text-black:400">The safekeeper account user should be someone (semi-)trusted. </strong>
        ...
        <li className="flex">
          <svg className="w-4 h-4 mr-1.5 text-green-500 dark:text-green-400 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
          <p><strong className="font-semibold text-gray-900 dark:text-black:400">Create a New Savings Account by clicking the tab and specifying a main account and a safekeeper account. </strong>
        ...
        <li className="flex">
          <svg className="w-4 h-4 mr-1.5 text-green-500 dark:text-green-400 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
          <p><strong className="font-semibold text-gray-900 dark:text-black:400">Each wallet address can only have one main account, and be the safekeeper for only one other account. </strong>
        ...
        <li className="flex">
          <svg className="w-4 h-4 mr-1.5 text-green-500 dark:text-green-400 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
          <p><strong className="font-semibold text-gray-900 dark:text-black:400">For the daily withdrawal limits, we recommend a ratio between the Main Account and the Safekeeper Account of about 20:1. </strong>
          For example, a Main Account Daily Limit of 1 ETH, safekeeper Account Daily Limit of 0.05 ETH. This will depend on the total amount of ETH -- and each token -- you plan on depositing.
        </p>
        </li>
        <li className="flex">
          <svg className="w-4 h-4 mr-1.5 text-green-500 dark:text-green-400 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
          <p><strong className="font-semibold text-gray-900 dark:text-black:400">When the safekeeper Account enables a large withdrawal, it applies to both ETH and any ERC20 token. </strong>
